...
Este repositório contém scripts simples para praticar os fundamentos da linguagem Python.

## 📂 Conteúdo do Repositório

* **`ex.py`**: Localiza o maior e o menor valor dentro de uma lista de números inseridos pelo usuário.
